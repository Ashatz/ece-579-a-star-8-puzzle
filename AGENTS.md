...
- **Repository:** https://github.com/greatstrength/ece-579-a-star-8-puzzle
- **Branch:** `v0.x-proto`
- **Python:** ≥ 3.10
...
1. Add the heuristic method to `SolvePuzzle` in `app/events/puzzle.py` with signature `(self, state: List[int], goal: List[int]) -> int`.
